...
import { NapoliRod5, NapolisetGolsC, NapolisetGolsPro, NapolisetJogos,  NapolisetPontos, NapolisetSG } from "../Redux/Reducers/GrupoAReducers/NapoliReducer";
import { LiverpoolRod5, LiverpoolsetGolsC, LiverpoolsetGolsPro, LiverpoolsetJogos,  LiverpoolsetPontos, LiverpoolsetSG } from "../Redux/Reducers/GrupoAReducers/LiverpoolReducer";
import { AjaxRod5, AjaxsetGolsC, AjaxsetGolsPro, AjaxsetJogos,  AjaxsetPontos, AjaxsetSG } from "../Redux/Reducers/GrupoAReducers/AjaxReducer";
import { RangersRod5, RangerssetGolsC, RangerssetGolsPro, RangerssetJogos,  RangerssetPontos, RangerssetSG } from "../Redux/Reducers/GrupoAReducers/RangersReducer";

import { AtleticoMRod5, AtleticoMsetGolsC, AtleticoMsetGolsPro, AtleticoMsetJogos,  AtleticoMsetPontos, AtleticoMsetSG } from "../Redux/Reducers/GrupoBReducers/AtleticoMReducer";
import { BayerLRod5, BayerLsetGolsC, BayerLsetGolsPro, BayerLsetJogos,  BayerLsetPontos, BayerLsetSG } from "../Redux/Reducers/GrupoBReducers/BayerLReducer";
import { BruggeRod5, BruggesetGolsC, BruggesetGolsPro, BruggesetJogos,  BruggesetPontos, BruggesetSG } from "../Redux/Reducers/GrupoBReducers/BruggeReducer";
import { PortoRod5, PortosetGolsC, PortosetGolsPro, PortosetJogos,  PortosetPontos, PortosetSG } from "../Redux/Reducers/GrupoBReducers/PortoReducer";

import { BayernMRod5, BayernMsetGolsC, BayernMsetGolsPro, BayernMsetJogos,  BayernMsetPontos, BayernMsetSG } from "../Redux/Reducers/GrupoCReducers/BayernMReducer";
import { BarcelonaRod5, BarcelonasetGolsC, BarcelonasetGolsPro, BarcelonasetJogos,  BarcelonasetPontos, BarcelonasetSG } from "../Redux/Reducers/GrupoCReducers/BarcelonaReducer";
import { InterRod5, IntersetGolsC, IntersetGolsPro, IntersetJogos,  IntersetPontos, IntersetSG } from "../Redux/Reducers/GrupoCReducers/InterReducer";
import { PlzenRod5, PlzensetGolsC, PlzensetGolsPro, PlzensetJogos,  PlzensetPontos, PlzensetSG } from "../Redux/Reducers/GrupoCReducers/PlzenReducer";

import { FrankfurtRod5, FrankfurtsetGolsC, FrankfurtsetGolsPro, FrankfurtsetJogos,  FrankfurtsetPontos, FrankfurtsetSG } from "../Redux/Reducers/GrupoDReducers/FrankfurtReducer";
import { MarselhaRod5, MarselhasetGolsC, MarselhasetGolsPro, MarselhasetJogos,  MarselhasetPontos, MarselhasetSG } from "../Redux/Reducers/GrupoDReducers/MarselhaReducer";
import { SportingRod5, SportingsetGolsC, SportingsetGolsPro, SportingsetJogos,  SportingsetPontos, SportingsetSG } from "../Redux/Reducers/GrupoDReducers/SportingReducer";
import { TottenhamRod5, TottenhamsetGolsC, TottenhamsetGolsPro, TottenhamsetJogos,  TottenhamsetPontos, TottenhamsetSG } from "../Redux/Reducers/GrupoDReducers/TottenhamReducer";

import { ChelseaRod5, ChelseasetGolsC, ChelseasetGolsPro, ChelseasetJogos,  ChelseasetPontos, ChelseasetSG } from "../Redux/Reducers/GrupoEReducers/ChelseaReducer";
import { MilanRod5, MilansetGolsC, MilansetGolsPro, MilansetJogos,  MilansetPontos, MilansetSG } from "../Redux/Reducers/GrupoEReducers/MilanReducer";
import { DinamoRod5, DinamosetGolsC, DinamosetGolsPro, DinamosetJogos,  DinamosetPontos, DinamosetSG } from "../Redux/Reducers/GrupoEReducers/DinamoReducer";
import { SalzburgRod5, SalzburgsetGolsC, SalzburgsetGolsPro, SalzburgsetJogos,  SalzburgsetPontos, SalzburgsetSG } from "../Redux/Reducers/GrupoEReducers/SalzburgReducer";

import { CelticRod5, CelticsetGolsC, CelticsetGolsPro, CelticsetJogos,  CelticsetPontos, CelticsetSG } from "../Redux/Reducers/GrupoFReducers/CelticReducer";
import { ShakhtarRod5, ShakhtarsetGolsC, ShakhtarsetGolsPro, ShakhtarsetJogos,  ShakhtarsetPontos, ShakhtarsetSG } from "../Redux/Reducers/GrupoFReducers/ShakhtarReducer";
import { RealMRod5, RealMsetGolsC, RealMsetGolsPro, RealMsetJogos,  RealMsetPontos, RealMsetSG } from "../Redux/Reducers/GrupoFReducers/RealMReducer";
import { LeipzigRod5, LeipzigsetGolsC, LeipzigsetGolsPro, LeipzigsetJogos,  LeipzigsetPontos, LeipzigsetSG } from "../Redux/Reducers/GrupoFReducers/LeipzigReducer";

import { DortmundRod5, DortmundsetGolsC, DortmundsetGolsPro, DortmundsetJogos,  DortmundsetPontos, DortmundsetSG } from "../Redux/Reducers/GrupoGReducers/DortmundReducer";
import { CopenhagaRod5, CopenhagasetGolsC, CopenhagasetGolsPro, CopenhagasetJogos,  CopenhagasetPontos, CopenhagasetSG } from "../Redux/Reducers/GrupoGReducers/CopenhagaReducer";
import { ManCRod5, ManCsetGolsC, ManCsetGolsPro, ManCsetJogos,  ManCsetPontos, ManCsetSG } from "../Redux/Reducers/GrupoGReducers/ManCReducer";
import { SevillaRod5, SevillasetGolsC, SevillasetGolsPro, SevillasetJogos,  SevillasetPontos, SevillasetSG } from "../Redux/Reducers/GrupoGReducers/SevillaReducer";

import { BenficaRod5, BenficasetGolsC, BenficasetGolsPro, BenficasetJogos,  BenficasetPontos, BenficasetSG } from "../Redux/Reducers/GrupoHReducers/BenficaReducer";
import { JuventusRod5, JuventussetGolsC, JuventussetGolsPro, JuventussetJogos,  JuventussetPontos, JuventussetSG } from "../Redux/Reducers/GrupoHReducers/JuventusReducer";
import { MaccabiRod5, MaccabisetGolsC, MaccabisetGolsPro, MaccabisetJogos,  MaccabisetPontos, MaccabisetSG } from "../Redux/Reducers/GrupoHReducers/MaccabiReducer";
import { PSGRod5, PSGsetGolsC, PSGsetGolsPro, PSGsetJogos,  PSGsetPontos, PSGsetSG } from "../Redux/Reducers/GrupoHReducers/PSGReducer";
import { useAppSelector } from "../Redux/Hooks/useAppSelector"
import { useDispatch } from "react-redux"
import { setRod5, setRod6 } from "../Redux/Reducers/showReducer";

export const Rodada5 = () =>{
    const show = useAppSelector(state => state.show)
    const [rodada5, setRodada5] = React.useState(0)
    ...
    React.useEffect(() => {
        ...
        setBayernMGol(Math.floor(Math.random() * 3))
        ...
        setMarselhaGol(Math.floor(Math.random() * 2))
        setTottenhamGol(Math.floor(Math.random() * 3))
        setSportingGol(Math.floor(Math.random() * 2))
        ...
        //Grupo G
        setSevillaGol(Math.floor(Math.random() * 5))
        ...
        //Grupo H
        setPSGGol(Math.floor(Math.random() * 6))
...
//Grupo H
    ...
    const SimuRod5 = () => {
        setRodada5(rodada5 + 1)
        dispatch(setRod5(false))
        dispatch(setRod6(true))
        //Grupo A
            ...
            dispatch(AjaxRod5(ajaxGol))
            dispatch(NapoliRod5(napoliGol))
            dispatch(LiverpoolRod5(liverpoolGol))
            dispatch(RangersRod5(rangersGol))
        //Grupo B
            ...
            dispatch(PortoRod5(portoGol))
            dispatch(BruggeRod5(bruggeGol))
            dispatch(BayerLRod5(bayerLGol))
            dispatch(AtleticoMRod5(atleticoMGol))
        //Grupo C
            ...
            dispatch(BayernMRod5(bayernMGol))
            dispatch(PlzenRod5(plzenGol))
            dispatch(BarcelonaRod5(barcelonaGol))
            dispatch(InterRod5(interGol))
        //Grupo D
            ...
            dispatch(FrankfurtRod5(frankfurtGol))
            dispatch(MarselhaRod5(marselhaGol))
            dispatch(SportingRod5(sportingGol))
            dispatch(TottenhamRod5(tottenhamGol))
        //Grupo E
            ...
            dispatch(ChelseaRod5(chelseaGol))
            dispatch(MilanRod5(milanGol))
            dispatch(DinamoRod5(dinamoGol))
            dispatch(SalzburgRod5(salzburgGol))
        //Grupo F
            ...
            dispatch(CelticRod5(celticGol))
            dispatch(ShakhtarRod5(shakhtarGol))
            dispatch(RealMRod5(realMGol))
            dispatch(LeipzigRod5(leipzigGol))
        //Grupo G
            ...
            dispatch(DortmundRod5(dortmundGol))
            dispatch(CopenhagaRod5(copenhagaGol))
            dispatch(ManCRod5(manCGol))
            dispatch(SevillaRod5(PSGGol))
        //Grupo H
            ...
            dispatch(BenficaRod5(benficaGol))
            dispatch(JuventusRod5(juventusGol))
            dispatch(MaccabiRod5(maccabiGol))
            dispatch(PSGRod5(PSGGol))
    }

    return (
        <C.Main showRodButton={show.rod5}>
            <button onClick={SimuRod5}>Simular 5° Rodada</button>
        </C.Main>
    )
}