...
import { NapoliRod3, NapolisetGolsC, NapolisetGolsPro, NapolisetJogos,  NapolisetPontos, NapolisetSG } from "../Redux/Reducers/GrupoAReducers/NapoliReducer";
import { LiverpoolRod3, LiverpoolsetGolsC, LiverpoolsetGolsPro, LiverpoolsetJogos,  LiverpoolsetPontos, LiverpoolsetSG } from "../Redux/Reducers/GrupoAReducers/LiverpoolReducer";
import { AjaxRod3, AjaxsetGolsC, AjaxsetGolsPro, AjaxsetJogos,  AjaxsetPontos, AjaxsetSG } from "../Redux/Reducers/GrupoAReducers/AjaxReducer";
import { RangersRod3, RangerssetGolsC, RangerssetGolsPro, RangerssetJogos,  RangerssetPontos, RangerssetSG } from "../Redux/Reducers/GrupoAReducers/RangersReducer";

import { AtleticoMRod3, AtleticoMsetGolsC, AtleticoMsetGolsPro, AtleticoMsetJogos,  AtleticoMsetPontos, AtleticoMsetSG } from "../Redux/Reducers/GrupoBReducers/AtleticoMReducer";
import { BayerLRod3, BayerLsetGolsC, BayerLsetGolsPro, BayerLsetJogos,  BayerLsetPontos, BayerLsetSG } from "../Redux/Reducers/GrupoBReducers/BayerLReducer";
import { BruggeRod3, BruggesetGolsC, BruggesetGolsPro, BruggesetJogos,  BruggesetPontos, BruggesetSG } from "../Redux/Reducers/GrupoBReducers/BruggeReducer";
import { PortoRod3, PortosetGolsC, PortosetGolsPro, PortosetJogos,  PortosetPontos, PortosetSG } from "../Redux/Reducers/GrupoBReducers/PortoReducer";

import { BayernMRod3, BayernMsetGolsC, BayernMsetGolsPro, BayernMsetJogos,  BayernMsetPontos, BayernMsetSG } from "../Redux/Reducers/GrupoCReducers/BayernMReducer";
import { BarcelonaRod3, BarcelonasetGolsC, BarcelonasetGolsPro, BarcelonasetJogos,  BarcelonasetPontos, BarcelonasetSG } from "../Redux/Reducers/GrupoCReducers/BarcelonaReducer";
import { InterRod3, IntersetGolsC, IntersetGolsPro, IntersetJogos,  IntersetPontos, IntersetSG } from "../Redux/Reducers/GrupoCReducers/InterReducer";
import { PlzenRod3, PlzensetGolsC, PlzensetGolsPro, PlzensetJogos,  PlzensetPontos, PlzensetSG } from "../Redux/Reducers/GrupoCReducers/PlzenReducer";

import { FrankfurtRod3, FrankfurtsetGolsC, FrankfurtsetGolsPro, FrankfurtsetJogos,  FrankfurtsetPontos, FrankfurtsetSG } from "../Redux/Reducers/GrupoDReducers/FrankfurtReducer";
import { MarselhaRod3, MarselhasetGolsC, MarselhasetGolsPro, MarselhasetJogos,  MarselhasetPontos, MarselhasetSG } from "../Redux/Reducers/GrupoDReducers/MarselhaReducer";
import { SportingRod3, SportingsetGolsC, SportingsetGolsPro, SportingsetJogos,  SportingsetPontos, SportingsetSG } from "../Redux/Reducers/GrupoDReducers/SportingReducer";
import { TottenhamRod3, TottenhamsetGolsC, TottenhamsetGolsPro, TottenhamsetJogos,  TottenhamsetPontos, TottenhamsetSG } from "../Redux/Reducers/GrupoDReducers/TottenhamReducer";

import { ChelseaRod3, ChelseasetGolsC, ChelseasetGolsPro, ChelseasetJogos,  ChelseasetPontos, ChelseasetSG } from "../Redux/Reducers/GrupoEReducers/ChelseaReducer";
import { MilanRod3, MilansetGolsC, MilansetGolsPro, MilansetJogos,  MilansetPontos, MilansetSG } from "../Redux/Reducers/GrupoEReducers/MilanReducer";
import { DinamoRod3, DinamosetGolsC, DinamosetGolsPro, DinamosetJogos,  DinamosetPontos, DinamosetSG } from "../Redux/Reducers/GrupoEReducers/DinamoReducer";
import { SalzburgRod3, SalzburgsetGolsC, SalzburgsetGolsPro, SalzburgsetJogos,  SalzburgsetPontos, SalzburgsetSG } from "../Redux/Reducers/GrupoEReducers/SalzburgReducer";

import { CelticRod3, CelticsetGolsC, CelticsetGolsPro, CelticsetJogos,  CelticsetPontos, CelticsetSG } from "../Redux/Reducers/GrupoFReducers/CelticReducer";
import { ShakhtarRod3, ShakhtarsetGolsC, ShakhtarsetGolsPro, ShakhtarsetJogos,  ShakhtarsetPontos, ShakhtarsetSG } from "../Redux/Reducers/GrupoFReducers/ShakhtarReducer";
import { RealMRod3, RealMsetGolsC, RealMsetGolsPro, RealMsetJogos,  RealMsetPontos, RealMsetSG } from "../Redux/Reducers/GrupoFReducers/RealMReducer";
import { LeipzigRod3, LeipzigsetGolsC, LeipzigsetGolsPro, LeipzigsetJogos,  LeipzigsetPontos, LeipzigsetSG } from "../Redux/Reducers/GrupoFReducers/LeipzigReducer";

import { DortmundRod3, DortmundsetGolsC, DortmundsetGolsPro, DortmundsetJogos,  DortmundsetPontos, DortmundsetSG } from "../Redux/Reducers/GrupoGReducers/DortmundReducer";
import { CopenhagaRod3, CopenhagasetGolsC, CopenhagasetGolsPro, CopenhagasetJogos,  CopenhagasetPontos, CopenhagasetSG } from "../Redux/Reducers/GrupoGReducers/CopenhagaReducer";
import { ManCRod3, ManCsetGolsC, ManCsetGolsPro, ManCsetJogos,  ManCsetPontos, ManCsetSG } from "../Redux/Reducers/GrupoGReducers/ManCReducer";
import { SevillaRod3, SevillasetGolsC, SevillasetGolsPro, SevillasetJogos,  SevillasetPontos, SevillasetSG } from "../Redux/Reducers/GrupoGReducers/SevillaReducer";

import { BenficaRod3, BenficasetGolsC, BenficasetGolsPro, BenficasetJogos,  BenficasetPontos, BenficasetSG } from "../Redux/Reducers/GrupoHReducers/BenficaReducer";
import { JuventusRod3, JuventussetGolsC, JuventussetGolsPro, JuventussetJogos,  JuventussetPontos, JuventussetSG } from "../Redux/Reducers/GrupoHReducers/JuventusReducer";
import { MaccabiRod3, MaccabisetGolsC, MaccabisetGolsPro, MaccabisetJogos,  MaccabisetPontos, MaccabisetSG } from "../Redux/Reducers/GrupoHReducers/MaccabiReducer";
import { PSGRod3, PSGsetGolsC, PSGsetGolsPro, PSGsetJogos,  PSGsetPontos, PSGsetSG } from "../Redux/Reducers/GrupoHReducers/PSGReducer";
import { useAppSelector } from "../Redux/Hooks/useAppSelector"
import { useDispatch } from "react-redux"
import { setRod3, setRod4 } from "../Redux/Reducers/showReducer";

export const Rodada3 = () =>{
    const show = useAppSelector(state => state.show)
    const [rodada3, setRodada3] = React.useState(0)
    ...
    React.useEffect(() => {
        ...
        //Grupo C
        setBayernMGol(Math.floor(Math.random() * 6))
        ...
        setMilanGol(Math.floor(Math.random() * 3))
        setSalzburgGol(Math.floor(Math.random() * 5))
        ...
        //Grupo F
        setLeipzigGol(Math.floor(Math.random() * 5))
        ...
        //Grupo G
        setSevillaGol(Math.floor(Math.random() * 4))
        setDortmundGol(Math.floor(Math.random() * 3))
        setManCGol(Math.floor(Math.random() * 6))
        ...
        //Grupo H
        setJuventusGol(Math.floor(Math.random() * 5))
        setMaccabiGol(Math.floor(Math.random() * 2))
        setBenficaGol(Math.floor(Math.random() * 4))
...
//Grupo H
    ...
    const SimuRod3 = () => {
        setRodada3(rodada3 + 1)
        dispatch(setRod3(false))
        dispatch(setRod4(true))
        //Grupo A
            ...
            dispatch(AjaxRod3(ajaxGol))
            dispatch(NapoliRod3(napoliGol))
            dispatch(LiverpoolRod3(liverpoolGol))
            dispatch(RangersRod3(rangersGol))
        //Grupo B
            ...
            dispatch(PortoRod3(portoGol))
            dispatch(BruggeRod3(bruggeGol))
            dispatch(BayerLRod3(bayerLGol))
            dispatch(AtleticoMRod3(atleticoMGol))
        //Grupo C
            ...
            dispatch(BayernMRod3(bayernMGol))
            dispatch(PlzenRod3(plzenGol))
            dispatch(BarcelonaRod3(barcelonaGol))
            dispatch(InterRod3(interGol))
        //Grupo D
            ...
            dispatch(FrankfurtRod3(frankfurtGol))
            dispatch(MarselhaRod3(marselhaGol))
            dispatch(SportingRod3(sportingGol))
            dispatch(TottenhamRod3(tottenhamGol))
        //Grupo E
            ...
            dispatch(ChelseaRod3(chelseaGol))
            dispatch(MilanRod3(milanGol))
            dispatch(DinamoRod3(dinamoGol))
            dispatch(SalzburgRod3(salzburgGol))
        //Grupo F
            ...
            dispatch(CelticRod3(celticGol))
            dispatch(ShakhtarRod3(shakhtarGol))
            dispatch(RealMRod3(realMGol))
            dispatch(LeipzigRod3(leipzigGol))
        //Grupo G
            ...
            dispatch(DortmundRod3(dortmundGol))
            dispatch(CopenhagaRod3(copenhagaGol))
            dispatch(ManCRod3(manCGol))
            dispatch(SevillaRod3(sevillaGol))
        //Grupo H
            ...
            dispatch(BenficaRod3(benficaGol))
            dispatch(JuventusRod3(juventusGol))
            dispatch(MaccabiRod3(maccabiGol))
            dispatch(PSGRod3(PSGGol))
    }

    return (
        <C.Main showRodButton={show.rod3}>
            <button onClick={SimuRod3}>Simular 3° Rodada</button>
        </C.Main>
    )
}